...
public class UserService {
	...
	public BookingVO bookTable(Long userId, BookingVO bookingVO) {
		Tables table = tableRepository.findByTableName(bookingVO.getTableName())
				.orElseThrow(() -> new EntityNotFoundException("Table not found with name: " + bookingVO.getTableName()));
		MealType mealType = mealTypeRepository.findByMealTypeName(bookingVO.getMealTypeName())
				.orElseThrow(() -> new EntityNotFoundException("Meal type not found with name: " + bookingVO.getMealTypeName()));
